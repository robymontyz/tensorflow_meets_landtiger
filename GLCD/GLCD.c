...
** Version:					2.1
** Descriptions:		Added bitmap drawing function and color area function
**                  Added __nop() inside delay function to work with compiler optimization
********************************************************************************************************/
...
/******************************************************************************
* Function Name  : LCD_ColorArea
* Description    : Color a rectangular area
* Input          : - x0: x-coordinate of the starting point
*                  - y0: y-coordinate of the starting point 
*				           - heigth: heigth of the area
...
* Attention		   : None
*******************************************************************************/
void LCD_ColorArea(uint16_t x0, uint16_t y0, uint16_t heigth, uint16_t width, uint16_t color)
{
	int i, j;
...
*   Return:                                                                    *
*******************************************************************************/
void LCD_Bitmap(uint16_t x, uint16_t y, unsigned int w, unsigned int h, unsigned char *bitmap) {
  unsigned int    i, j;
  unsigned short *bitmap_ptr = (unsigned short *)bitmap;
	
	for (i = 0; i < h; i++) {
		for (j = 0; j < w; j++) {
			uint16_t pixel = *(uint16_t *) (bitmap_ptr);
			LCD_SetPoint(x + j, y + i, pixel);
			bitmap_ptr += 1;
		}
	}
}
