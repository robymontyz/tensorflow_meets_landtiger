...
**
**--------------------------------------------------------------------------------------------------------
** Modified by:             Roberto Alessi - s290280
** Modified date:           2021-06-21
** Version:                 v1.1
** Descriptions:            Added function to draw bigger point on screen
...
/*******************************************************************************
* Function Name  : TP_DrawBigPoint
* Description    : 在指定座标画点
* Input          : - Xpos: Row Coordinate
*                  - Ypos: Line Coordinate 
*                  - size: Size of drawn point
* Output         : None
* Return         : None
* Attention		   : None
*******************************************************************************/
void TP_DrawBigPoint(uint16_t Xpos,uint16_t Ypos, uint16_t size)
{
	int i, j;

	for(i=-size; i<=size; i++) {
		for(j=-size; j<=size; j++) {
			LCD_SetPoint(Xpos+j,Ypos+i,Black);
		}
	}
}
